"""Add password hashes and browser auth sessions.

Revision ID: 0005_auth_sessions
Revises: 0004_security_integrations
...
down_revision: str | None = "0004_security_integrations"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None


def upgrade() -> None:
    op.add_column("users", sa.Column("password_hash", sa.String(length=240), nullable=True))
