...
4. Let Render create:
   ...
   - `agentguard-postgres`
   - `agentguard-redis`
5. If Render changes the API public hostname, update the web service env var:

```text
AGENTGUARD_API_URL=https://your-agentguard-api.onrender.com
```

6. Keep `AGENTGUARD_JUDGE_API_KEY` empty unless you want to enable LLM judge checks.
